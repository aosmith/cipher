...
├── msi/
│   └── Cipher_1.0.0_x64_en-US.msi
└── nsis/
    └── Cipher_1.0.0_x64-setup.exe
```
...
src-tauri/target/release/bundle/
├── deb/
│   └── cipher_1.0.0_amd64.deb
└── appimage/
    └── cipher_1.0.0_amd64.AppImage
```
...
```bash
# Sign .deb package
debsign -k YOUR_GPG_KEY cipher_1.0.0_amd64.deb

# Sign .AppImage  
gpg --detach-sign cipher_1.0.0_amd64.AppImage
```
