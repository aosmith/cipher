...
├── msi/
│   └── Cipher_v0.6.1_x64_en-US.msi
└── nsis/
    └── Cipher_v0.6.1_x64-setup.exe
```
...
```bash
# Sign .deb package
debsign -k YOUR_GPG_KEY cipher_v0.6.1_amd64.deb

# Sign .AppImage  
gpg --detach-sign cipher_v0.6.1_amd64.AppImage
```
