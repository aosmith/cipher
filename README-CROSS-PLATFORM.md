...
├── msi/
│   └── Cipher_0.7.2_x64_en-US.msi
└── nsis/
    └── Cipher_0.7.2_x64-setup.exe
```
...
```bash
# Sign .deb package
debsign -k YOUR_GPG_KEY cipher_0.7.2_amd64.deb

# Sign .AppImage  
gpg --detach-sign cipher_0.7.2_amd64.AppImage
```
