...
size_t __fread_chk(void* _Nonnull, size_t, size_t, FILE* _Nonnull, size_t) __attribute__((__availability__(android,strict,introduced=24 )));
size_t __fwrite_chk(const void* _Nonnull, size_t, size_t, FILE* _Nonnull, size_t) __attribute__((__availability__(android,strict,introduced=24 )));
static __inline__ __attribute__((__no_stack_protector__)) __attribute__((__always_inline__)) __attribute__((__format__(printf, 3, 0)))
int vsnprintf(char* const _Null_unspecified __attribute__((__pass_object_size__(1))) dest, size_t size, const char* _Nonnull format, va_list ap)
        __attribute__((__diagnose_as_builtin__(__builtin_vsnprintf, 1, 2, 3, 4)))
        __attribute__((__overloadable__)) {
    return __builtin___vsnprintf_chk(dest, size, 0, __builtin_object_size(((dest)), (1)), format, ap);
}
static __inline__ __attribute__((__no_stack_protector__)) __attribute__((__always_inline__)) __attribute__((__format__(printf, 2, 0)))
int vsprintf(char* const _Null_unspecified __attribute__((__pass_object_size__(1))) dest, const char* _Nonnull format, va_list ap) __attribute__((__overloadable__)) {
    return __builtin___vsprintf_chk(dest, 0, __builtin_object_size(((dest)), (1)), format, ap);
}
static __attribute__((__unused__))
int sprintf(char* _Null_unspecified dest, const char* _Nonnull format)
    __attribute__((__overloadable__))
    __attribute__((__enable_if__(((__builtin_object_size(((dest)), (1))) != ((size_t) -1) && (__builtin_object_size(((dest)), (1))) < (__builtin_strlen(format))), "format string will always overflow destination buffer")))
    __attribute__((__unavailable__("format string will always overflow destination buffer")));
static __inline__ __attribute__((__format__(printf, 2, 3)))
int sprintf(char* const _Null_unspecified __attribute__((__pass_object_size__(1))) dest, const char* _Nonnull format, ...) __attribute__((__overloadable__)) {
    va_list va;
...
int snprintf(char* const _Null_unspecified __attribute__((__pass_object_size__(1))) dest, size_t size, const char* _Nonnull format, ...)
        __attribute__((__diagnose_as_builtin__(__builtin_snprintf, 1, 2, 3)))
        __attribute__((__overloadable__)) {
    va_list va;
    __builtin_va_start(va, format);
...
static __inline__ __attribute__((__no_stack_protector__)) __attribute__((__always_inline__))
size_t fread(void* const _Nonnull __attribute__((__pass_object_size__(0))) buf, size_t size, size_t count, FILE* _Nonnull stream)
        __attribute__((__overloadable__))
        __attribute__((__diagnose_if__(((long unsigned int)-1 / (size) < (count)), "in call to 'fread', size * count overflows", "error")))
        __attribute__((__diagnose_if__(((__builtin_object_size(((buf)), (0))) != ((size_t) -1) && (__builtin_object_size(((buf)), (0))) < (size * count)), "in call to 'fread', size * count is too large for the given buffer", "error"))) {
    size_t bos = __builtin_object_size(((buf)), (0));
    if (!((bos) == ((size_t) -1) || (__builtin_constant_p((size) * (count)) && bos >= (size) * (count) && (!((long unsigned int)-1 / (size) < (count)))))) {
        return __fread_chk(buf, size, count, stream, bos);
    }
    return (&fread)(buf, size, count, stream);
}
static __inline__ __attribute__((__no_stack_protector__)) __attribute__((__always_inline__))
size_t fwrite(const void* const _Nonnull __attribute__((__pass_object_size__(0))) buf, size_t size, size_t count, FILE* _Nonnull stream)
        __attribute__((__overloadable__))
        __attribute__((__diagnose_if__(((long unsigned int)-1 / (size) < (count)), "in call to 'fwrite', size * count overflows", "error")))
        __attribute__((__diagnose_if__(((__builtin_object_size(((buf)), (0))) != ((size_t) -1) && (__builtin_object_size(((buf)), (0))) < (size * count)), "in call to 'fwrite', size * count is too large for the given buffer", "error"))) {
    size_t bos = __builtin_object_size(((buf)), (0));
    if (!((bos) == ((size_t) -1) || (__builtin_constant_p((size) * (count)) && bos >= (size) * (count) && (!((long unsigned int)-1 / (size) < (count)))))) {
...
static __inline__ __attribute__((__no_stack_protector__)) __attribute__((__always_inline__))
char* _Nullable fgets(char* const _Nonnull __attribute__((__pass_object_size__(1))) dest, int size, FILE* _Nonnull stream)
        __attribute__((__overloadable__))
        __attribute__((__diagnose_if__(size < 0, "in call to 'fgets', size should not be negative", "error")))
        __attribute__((__diagnose_if__(((__builtin_object_size(((dest)), (1))) != ((size_t) -1) && (__builtin_object_size(((dest)), (1))) < (size)), "in call to 'fgets', size is larger than the destination buffer", "error"))) {
...
mode_t umask(mode_t mode)
    ...
    __attribute__((__diagnose_if__(mode & ~0777, "'umask' called with invalid mode", "error"))) {
...
char* _Nullable realpath(const char* _Nonnull path, char* _Nullable resolved)
        __attribute__((__diagnose_if__(!path, "'realpath': NULL path is never correct; flipped arguments?", "error")))
        __attribute__((__diagnose_if__(((__builtin_object_size(((resolved)), (1))) != ((size_t) -1) && (__builtin_object_size(((resolved)), (1))) < (4096)), "'realpath' output parameter must be NULL or a pointer to a buffer " "with >= PATH_MAX bytes", "error")));
...
static __inline__ __attribute__((__no_stack_protector__)) __attribute__((__always_inline__))
void __bionic_bcopy(const void * _Nonnull src, void* _Nonnull const dst __attribute__((__pass_object_size__(0))), size_t len)
        __attribute__((__overloadable__))
        __attribute__((__diagnose_if__(((__builtin_object_size(((dst)), (0))) != ((size_t) -1) && (__builtin_object_size(((dst)), (0))) < (len)), "'bcopy' called with size bigger than buffer", "error"))) {
...
static __inline__ __attribute__((__no_stack_protector__)) __attribute__((__always_inline__))
void __bionic_bzero(void* _Nonnull const b __attribute__((__pass_object_size__(0))), size_t len)
        __attribute__((__overloadable__))
        __attribute__((__diagnose_if__(((__builtin_object_size(((b)), (0))) != ((size_t) -1) && (__builtin_object_size(((b)), (0))) < (len)), "'bzero' called with size bigger than buffer", "error"))) {
    size_t bos = __builtin_object_size(((b)), (0));
    if (!(((bos)) == ((size_t) -1) || (__builtin_constant_p((len)) && (bos) >= (len) && (1)))) {
...
void* _Nullable __memchr_chk(const void* _Nonnull, int, size_t, size_t) __attribute__((__availability__(android,strict,introduced=23 )));
void* _Nullable __memrchr_chk(const void* _Nonnull, int, size_t, size_t) __attribute__((__availability__(android,strict,introduced=23 )));
...
extern void* _Nullable __memrchr_real(const void* _Nonnull, int, size_t) __asm__("memrchr");
static __inline__ __attribute__((__no_stack_protector__)) __attribute__((__always_inline__))
void* _Nonnull memcpy(void* _Nonnull const dst __attribute__((__pass_object_size__(0))), const void* _Nonnull src, size_t copy_amount)
        __attribute__((__diagnose_as_builtin__(__builtin_memcpy, 1, 2, 3)))
        __attribute__((__overloadable__)) {
    return __builtin___memcpy_chk(dst, src, copy_amount, __builtin_object_size(((dst)), (0)));
}
static __inline__ __attribute__((__no_stack_protector__)) __attribute__((__always_inline__))
void* _Nonnull memmove(void* _Nonnull const dst __attribute__((__pass_object_size__(0))), const void* _Nonnull src, size_t len)
        __attribute__((__diagnose_as_builtin__(__builtin_memmove, 1, 2, 3)))
        __attribute__((__overloadable__)) {
    return __builtin___memmove_chk(dst, src, len, __builtin_object_size(((dst)), (0)));
}
static __inline__ __attribute__((__no_stack_protector__)) __attribute__((__always_inline__))
char* _Nonnull stpcpy(char* _Nonnull const dst __attribute__((__pass_object_size__(1))), const char* _Nonnull src)
        __attribute__((__overloadable__))
        __attribute__((__diagnose_if__(((__builtin_object_size(((dst)), (1))) != ((size_t) -1) && (__builtin_object_size(((dst)), (1))) <= (__builtin_strlen(src))), "'stpcpy' called with string bigger than buffer", "error"))) {
    return __builtin___stpcpy_chk(dst, src, __builtin_object_size(((dst)), (1)));
}
static __inline__ __attribute__((__no_stack_protector__)) __attribute__((__always_inline__))
char* _Nonnull strcpy(char* _Nonnull const dst __attribute__((__pass_object_size__(1))), const char* _Nonnull src)
        __attribute__((__diagnose_as_builtin__(__builtin_strcpy, 1, 2)))
        __attribute__((__overloadable__))
        __attribute__((__diagnose_if__(((__builtin_object_size(((dst)), (1))) != ((size_t) -1) && (__builtin_object_size(((dst)), (1))) <= (__builtin_strlen(src))), "'strcpy' called with string bigger than buffer", "error"))) {
    return __builtin___strcpy_chk(dst, src, __builtin_object_size(((dst)), (1)));
}
static __inline__ __attribute__((__no_stack_protector__)) __attribute__((__always_inline__))
char* _Nonnull strcat(char* _Nonnull const dst __attribute__((__pass_object_size__(1))), const char* _Nonnull src)
        __attribute__((__overloadable__))
        __attribute__((__diagnose_if__(((__builtin_object_size(((dst)), (1))) != ((size_t) -1) && (__builtin_object_size(((dst)), (1))) <= (__builtin_strlen(src))), "'strcat' called with string bigger than buffer", "error"))) {
    return __builtin___strcat_chk(dst, src, __builtin_object_size(((dst)), (1)));
}
static __inline__ __attribute__((__no_stack_protector__)) __attribute__((__always_inline__))
char* _Nonnull strncat(char* _Nonnull const dst __attribute__((__pass_object_size__(1))), const char* _Nonnull src, size_t n)
       __attribute__((__diagnose_as_builtin__(__builtin_strncat, 1, 2, 3)))
       __attribute__((__overloadable__)) {
    return __builtin___strncat_chk(dst, src, n, __builtin_object_size(((dst)), (1)));
}
static __inline__ __attribute__((__no_stack_protector__)) __attribute__((__always_inline__))
void* _Nonnull memset(void* _Nonnull const s __attribute__((__pass_object_size__(0))), int c, size_t n) __attribute__((__overloadable__))
        __attribute__((__diagnose_as_builtin__(__builtin_memset, 1, 2, 3)))
        __attribute__((__diagnose_if__(c && !n, "'memset' will set 0 bytes; maybe the arguments got flipped?", "warning"))) {
    return __builtin___memset_chk(s, c, n, __builtin_object_size(((s)), (0)));
}
static __inline__ __attribute__((__no_stack_protector__)) __attribute__((__always_inline__))
void* _Nullable memchr(const void* _Nonnull const s __attribute__((__pass_object_size__(1))), int c, size_t n) __attribute__((__overloadable__)) {
...
static __inline__ __attribute__((__no_stack_protector__)) __attribute__((__always_inline__))
void* _Nullable __memrchr_fortify(const void* _Nonnull const __attribute__((__pass_object_size__(1))) s, int c, size_t n) __attribute__((__overloadable__)) {
    size_t bos = __builtin_object_size(((s)), (1));
    if ((((bos)) == ((size_t) -1) || (__builtin_constant_p((n)) && (bos) >= (n) && (1)))) {
...
static __inline__ __attribute__((__no_stack_protector__)) __attribute__((__always_inline__))
char* _Nonnull stpncpy(char* _Nonnull const dst __attribute__((__pass_object_size__(1))), const char* _Nonnull const src __attribute__((__pass_object_size__(1))), size_t n)
        __attribute__((__diagnose_as_builtin__(__builtin_stpncpy, 1, 2, 3)))
        __attribute__((__overloadable__)) {
...
static __inline__ __attribute__((__no_stack_protector__)) __attribute__((__always_inline__))
char* _Nonnull strncpy(char* _Nonnull const dst __attribute__((__pass_object_size__(1))), const char* _Nonnull const src __attribute__((__pass_object_size__(1))), size_t n)
        __attribute__((__diagnose_as_builtin__(__builtin_strncpy, 1, 2, 3)))
        __attribute__((__overloadable__)) {
    size_t bos_dst = __builtin_object_size(((dst)), (1));
    size_t bos_src = __builtin_object_size(((src)), (1));
    if (bos_src == ((size_t) -1)) {
...
static __inline__ __attribute__((__no_stack_protector__)) __attribute__((__always_inline__))
size_t strlcpy(char* _Nonnull const dst __attribute__((__pass_object_size__(1))), const char* _Nonnull src, size_t size)
        __attribute__((__overloadable__))
        __attribute__((__diagnose_if__(((__builtin_object_size(((dst)), (1))) != ((size_t) -1) && (__builtin_object_size(((dst)), (1))) < (size)), "'strlcpy' called with size bigger than buffer", "error"))) {
    return __strlcpy_chk(dst, src, size, __builtin_object_size(((dst)), (1)));
}
static __inline__ __attribute__((__no_stack_protector__)) __attribute__((__always_inline__))
size_t strlcat(char* _Nonnull const dst __attribute__((__pass_object_size__(1))), const char* _Nonnull src, size_t size)
        __attribute__((__overloadable__))
        __attribute__((__diagnose_if__(((__builtin_object_size(((dst)), (1))) != ((size_t) -1) && (__builtin_object_size(((dst)), (1))) < (size)), "'strlcat' called with size bigger than buffer", "error"))) {
    return __strlcat_chk(dst, src, size, __builtin_object_size(((dst)), (1)));
}
static __inline__ __attribute__((__no_stack_protector__)) __attribute__((__always_inline__))
size_t strlen(const char* _Nonnull const s __attribute__((__pass_object_size__(0)))) __attribute__((__overloadable__)) {
    return __strlen_chk(s, __builtin_object_size(((s)), (0)));
}
static __inline__ __attribute__((__no_stack_protector__)) __attribute__((__always_inline__))
char* _Nullable strchr(const char* _Nonnull const s __attribute__((__pass_object_size__(1))), int c) __attribute__((__overloadable__)) {
    size_t bos = __builtin_object_size(((s)), (1));
    if (bos != ((size_t) -1)) {
...
static __inline__ __attribute__((__no_stack_protector__)) __attribute__((__always_inline__))
char* _Nullable strrchr(const char* _Nonnull const s __attribute__((__pass_object_size__(1))), int c) __attribute__((__overloadable__)) {
    size_t bos = __builtin_object_size(((s)), (1));
    if (bos != ((size_t) -1)) {
...
static __inline__ __attribute__((__no_stack_protector__)) __attribute__((__always_inline__))
void* _Nullable memrchr(const void* _Nonnull const __attribute__((__pass_object_size__(1))) s, int c, size_t n) __attribute__((__overloadable__)) {
...
char* _Nullable __getcwd_chk(char* _Nullable, size_t, size_t) __attribute__((__availability__(android,strict,introduced=24 )));
ssize_t __pread_chk(int, void* _Nonnull, size_t, off_t, size_t) __attribute__((__availability__(android,strict,introduced=23 )));
ssize_t __pread_real(int, void* _Nonnull, size_t, off_t) __asm__("pread");
ssize_t __pread64_chk(int, void* _Nonnull, size_t, off64_t, size_t) __attribute__((__availability__(android,strict,introduced=23 )));
ssize_t __pread64_real(int, void* _Nonnull, size_t, off64_t) __asm__("pread64");
ssize_t __pwrite_chk(int, const void* _Nonnull, size_t, off_t, size_t) __attribute__((__availability__(android,strict,introduced=24 )));
ssize_t __pwrite_real(int, const void* _Nonnull, size_t, off_t) __asm__("pwrite");
ssize_t __pwrite64_chk(int, const void* _Nonnull, size_t, off64_t, size_t) __attribute__((__availability__(android,strict,introduced=24 )));
ssize_t __pwrite64_real(int, const void* _Nonnull, size_t, off64_t) __asm__("pwrite64");
ssize_t __read_chk(int, void* _Null_unspecified, size_t, size_t);
ssize_t __write_chk(int, const void* _Null_unspecified, size_t, size_t) __attribute__((__availability__(android,strict,introduced=24 )));
ssize_t __readlink_chk(const char* _Nonnull, char* _Nonnull, size_t, size_t) __attribute__((__availability__(android,strict,introduced=23 )));
ssize_t __readlinkat_chk(int dirfd, const char* _Nonnull, char* _Nonnull, size_t, size_t) __attribute__((__availability__(android,strict,introduced=23 )));
static __inline__ __attribute__((__no_stack_protector__)) __attribute__((__always_inline__))
char* _Nullable getcwd(char* const _Nullable __attribute__((__pass_object_size__(1))) buf, size_t size)
        __attribute__((__overloadable__))
        __attribute__((__diagnose_if__((((__builtin_object_size(((buf)), (1)))) != ((size_t) -1) && ((__builtin_object_size(((buf)), (1)))) < ((size))), "in call to '" "getcwd" "', '" "size" "' bytes overflows the given object", "error"))) {
    size_t bos = __builtin_object_size(((buf)), (1));
    if (!(((bos)) == ((size_t) -1) || (__builtin_constant_p((size)) && (bos) >= (size) && (1)))) {
        return __getcwd_chk(buf, size, bos);
    }
    return (&getcwd)(buf, size);
}
static __inline__ __attribute__((__no_stack_protector__)) __attribute__((__always_inline__))
ssize_t pread(int fd, void* const _Nonnull __attribute__((__pass_object_size__(0))) buf, size_t count, off_t offset)
        __attribute__((__overloadable__))
        __attribute__((__diagnose_if__((count) > 9223372036854775807L, "in call to '" "pread" "', '" "count" "' must be <= SSIZE_MAX", "error")))
        __attribute__((__diagnose_if__((((__builtin_object_size(((buf)), (0)))) != ((size_t) -1) && ((__builtin_object_size(((buf)), (0)))) < ((count))), "in call to '" "pread" "', '" "count" "' bytes overflows the given object", "error"))) {
    size_t bos = __builtin_object_size(((buf)), (0));
    if (!(((((bos)) == ((size_t) -1) || (__builtin_constant_p((count)) && (bos) >= (count) && ((bos) <= 9223372036854775807L))) && __builtin_constant_p(count) && (count) <= 9223372036854775807L))) {
        return __pread_chk(fd, buf, count, offset, bos);
    }
    return __pread_real(fd, buf, count, offset);
}
static __inline__ __attribute__((__no_stack_protector__)) __attribute__((__always_inline__))
ssize_t pread64(int fd, void* const _Nonnull __attribute__((__pass_object_size__(0))) buf, size_t count, off64_t offset)
        __attribute__((__overloadable__))
        __attribute__((__diagnose_if__((count) > 9223372036854775807L, "in call to '" "pread64" "', '" "count" "' must be <= SSIZE_MAX", "error")))
        __attribute__((__diagnose_if__((((__builtin_object_size(((buf)), (0)))) != ((size_t) -1) && ((__builtin_object_size(((buf)), (0)))) < ((count))), "in call to '" "pread64" "', '" "count" "' bytes overflows the given object", "error"))) {
    size_t bos = __builtin_object_size(((buf)), (0));
    if (!(((((bos)) == ((size_t) -1) || (__builtin_constant_p((count)) && (bos) >= (count) && ((bos) <= 9223372036854775807L))) && __builtin_constant_p(count) && (count) <= 9223372036854775807L))) {
...
static __inline__ __attribute__((__no_stack_protector__)) __attribute__((__always_inline__))
ssize_t pwrite(int fd, const void* const _Nonnull __attribute__((__pass_object_size__(0))) buf, size_t count, off_t offset)
        __attribute__((__overloadable__))
        __attribute__((__diagnose_if__((count) > 9223372036854775807L, "in call to '" "pwrite" "', '" "count" "' must be <= SSIZE_MAX", "error")))
        __attribute__((__diagnose_if__((((__builtin_object_size(((buf)), (0)))) != ((size_t) -1) && ((__builtin_object_size(((buf)), (0)))) < ((count))), "in call to '" "pwrite" "', '" "count" "' bytes overflows the given object", "error"))) {
    size_t bos = __builtin_object_size(((buf)), (0));
    if (!(((((bos)) == ((size_t) -1) || (__builtin_constant_p((count)) && (bos) >= (count) && ((bos) <= 9223372036854775807L))) && __builtin_constant_p(count) && (count) <= 9223372036854775807L))) {
...
static __inline__ __attribute__((__no_stack_protector__)) __attribute__((__always_inline__))
ssize_t pwrite64(int fd, const void* const _Nonnull __attribute__((__pass_object_size__(0))) buf, size_t count, off64_t offset)
        __attribute__((__overloadable__))
        __attribute__((__diagnose_if__((count) > 9223372036854775807L, "in call to '" "pwrite64" "', '" "count" "' must be <= SSIZE_MAX", "error")))
        __attribute__((__diagnose_if__((((__builtin_object_size(((buf)), (0)))) != ((size_t) -1) && ((__builtin_object_size(((buf)), (0)))) < ((count))), "in call to '" "pwrite64" "', '" "count" "' bytes overflows the given object", "error"))) {
    size_t bos = __builtin_object_size(((buf)), (0));
    if (!(((((bos)) == ((size_t) -1) || (__builtin_constant_p((count)) && (bos) >= (count) && ((bos) <= 9223372036854775807L))) && __builtin_constant_p(count) && (count) <= 9223372036854775807L))) {
...
static __inline__ __attribute__((__no_stack_protector__)) __attribute__((__always_inline__))
ssize_t read(int fd, void* const _Null_unspecified __attribute__((__pass_object_size__(0))) buf, size_t count)
        __attribute__((__overloadable__))
        __attribute__((__diagnose_if__((count) > 9223372036854775807L, "in call to '" "read" "', '" "count" "' must be <= SSIZE_MAX", "error")))
        __attribute__((__diagnose_if__((((__builtin_object_size(((buf)), (0)))) != ((size_t) -1) && ((__builtin_object_size(((buf)), (0)))) < ((count))), "in call to '" "read" "', '" "count" "' bytes overflows the given object", "error"))) {
    size_t bos = __builtin_object_size(((buf)), (0));
    if (!(((((bos)) == ((size_t) -1) || (__builtin_constant_p((count)) && (bos) >= (count) && ((bos) <= 9223372036854775807L))) && __builtin_constant_p(count) && (count) <= 9223372036854775807L))) {
...
static __inline__ __attribute__((__no_stack_protector__)) __attribute__((__always_inline__))
ssize_t write(int fd, const void* const _Null_unspecified __attribute__((__pass_object_size__(0))) buf, size_t count)
        __attribute__((__overloadable__))
        __attribute__((__diagnose_if__((count) > 9223372036854775807L, "in call to '" "write" "', '" "count" "' must be <= SSIZE_MAX", "error")))
        __attribute__((__diagnose_if__((((__builtin_object_size(((buf)), (0)))) != ((size_t) -1) && ((__builtin_object_size(((buf)), (0)))) < ((count))), "in call to '" "write" "', '" "count" "' bytes overflows the given object", "error"))) {
    size_t bos = __builtin_object_size(((buf)), (0));
    if (!(((((bos)) == ((size_t) -1) || (__builtin_constant_p((count)) && (bos) >= (count) && ((bos) <= 9223372036854775807L))) && __builtin_constant_p(count) && (count) <= 9223372036854775807L))) {
...
static __inline__ __attribute__((__no_stack_protector__)) __attribute__((__always_inline__))
ssize_t readlink(const char* _Nonnull path, char* _Nonnull const __attribute__((__pass_object_size__(1))) buf, size_t size)
        __attribute__((__overloadable__))
        __attribute__((__diagnose_if__((size) > 9223372036854775807L, "in call to '" "readlink" "', '" "size" "' must be <= SSIZE_MAX", "error")))
        __attribute__((__diagnose_if__((((__builtin_object_size(((buf)), (1)))) != ((size_t) -1) && ((__builtin_object_size(((buf)), (1)))) < ((size))), "in call to '" "readlink" "', '" "size" "' bytes overflows the given object", "error"))) {
    size_t bos = __builtin_object_size(((buf)), (1));
    if (!(((((bos)) == ((size_t) -1) || (__builtin_constant_p((size)) && (bos) >= (size) && ((bos) <= 9223372036854775807L))) && __builtin_constant_p(size) && (size) <= 9223372036854775807L))) {
        return __readlink_chk(path, buf, size, bos);
    }
    return (&readlink)(path, buf, size);
}
static __inline__ __attribute__((__no_stack_protector__)) __attribute__((__always_inline__))
ssize_t readlinkat(int dirfd, const char* _Nonnull path, char* const _Nonnull __attribute__((__pass_object_size__(1))) buf, size_t size)
        __attribute__((__overloadable__))
        __attribute__((__diagnose_if__((size) > 9223372036854775807L, "in call to '" "readlinkat" "', '" "size" "' must be <= SSIZE_MAX", "error")))
        __attribute__((__diagnose_if__((((__builtin_object_size(((buf)), (1)))) != ((size_t) -1) && ((__builtin_object_size(((buf)), (1)))) < ((size))), "in call to '" "readlinkat" "', '" "size" "' bytes overflows the given object", "error"))) {
    size_t bos = __builtin_object_size(((buf)), (1));
    if (!(((((bos)) == ((size_t) -1) || (__builtin_constant_p((size)) && (bos) >= (size) && ((bos) <= 9223372036854775807L))) && __builtin_constant_p(size) && (size) <= 9223372036854775807L))) {
...
void __sanitizer_symbolize_pc(void *pc, const char *fmt,
                                              char *out_buf,
                                              size_t out_buf_size);
...
void __sanitizer_weak_hook_memmem(void *called_pc,
                                                  ...
                                                  void *result);
void __sanitizer_print_memory_profile(
...
#define __BIONIC_FORTIFY_INLINE static __inline __attribute__((__no_stack_protector__)) __always_inline __VERSIONER_FORTIFY_INLINE
...
#define __bos_trivially_ge_mul(bos_val,size,count) __bos_dynamic_check_impl_and(bos_val, >=, (size) * (count), !__unsafe_check_mul_overflow(size, count))
...
#define __MALLINFO_BODY size_t arena; size_t ordblks; size_t smblks; size_t hblks; size_t hblkhd; size_t usmblks; size_t fsmblks; size_t uordblks; size_t fordblks; size_t keepcost;
...
#define PRIb16 "b"
#define PRIb32 "b"
#define PRIb64 __PRI_64_prefix"b"
#define PRIbLEAST8 "b"
#define PRIbLEAST16 "b"
#define PRIbLEAST32 "b"
#define PRIbLEAST64 __PRI_64_prefix"b"
#define PRIbFAST8 "b"
#define PRIbFAST16 __PRI_FAST_prefix"b"
#define PRIbFAST32 __PRI_FAST_prefix"b"
#define PRIbFAST64 __PRI_64_prefix"b"
#define PRIbMAX "jb"
#define PRIbPTR __PRI_PTR_prefix"b"
#define PRIB8 "B"
#define PRIB16 "B"
#define PRIB32 "B"
#define PRIB64 __PRI_64_prefix"B"
...
#define SCNb16 "hb"
#define SCNb32 "b"
#define SCNb64 __PRI_64_prefix"b"
#define SCNbLEAST8 "hhb"
#define SCNbLEAST16 "hb"
#define SCNbLEAST32 "b"
#define SCNbLEAST64 __PRI_64_prefix"b"
#define SCNbFAST8 "hhb"
#define SCNbFAST16 __PRI_FAST_prefix"b"
#define SCNbFAST32 __PRI_FAST_prefix"b"
#define SCNbFAST64 __PRI_64_prefix"b"
#define SCNbMAX "jb"
#define SCNbPTR __PRI_PTR_prefix"b"
#define SCNB8 "hhB"
#define SCNB16 "hB"
#define SCNB32 "B"
#define SCNB64 __PRI_64_prefix"B"
...
#define __error_if_overflows_objectsize(what,objsize,fn) __clang_error_if(__bos_unevaluated_lt((objsize), (what)), "in call to '" #fn "', '" #what "' bytes overflows the given object")
#define __bos_trivially_ge_no_overflow(bos_val,index) ((__bos_dynamic_check_impl_and((bos_val), >=, (index), (bos_val) <= SSIZE_MAX) && __builtin_constant_p(index) && (index) <= SSIZE_MAX))
