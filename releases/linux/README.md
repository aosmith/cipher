...
- **Version**: v0.5.7
- **DEB Package**: `cipher_0.5.7_amd64.deb` (~15MB)
- **AppImage**: `cipher_0.5.7_amd64.AppImage` (~18MB)
...
```bash
# Download
wget https://github.com/aosmith/cipher/releases/download/v0.5.7/cipher_0.5.7_amd64.AppImage

# Make executable
chmod +x cipher_0.5.7_amd64.AppImage

# Run
./cipher_0.5.7_amd64.AppImage
```
...
│   ├── cipher_0.5.7_amd64.deb        # DEB package
│   ├── cipher_0.5.7_amd64.AppImage   # AppImage
│   ├── checksums.txt
│   └── CHANGELOG.md
...
ldd ./cipher_0.5.7_amd64.AppImage
