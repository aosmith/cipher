...
- **Version**: v0.5.0
- **DEB Package**: `cipher_0.5.0_amd64.deb` (~15MB)
- **AppImage**: `cipher_0.5.0_amd64.AppImage` (~18MB)
...
│   ├── cipher_0.5.0_amd64.deb        # DEB package
│   ├── cipher_0.5.0_amd64.AppImage   # AppImage
│   ├── checksums.txt
│   └── CHANGELOG.md
...
ldd ./cipher_0.5.0_amd64.AppImage
