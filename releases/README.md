...
|----------|----------|------|---------|
| **Windows** | [Cipher_0.5.9_x64.msi](windows/latest/Cipher_0.5.9_x64.msi) | ~12MB | `placeholder` |
| **macOS (ARM64)** | [Cipher_0.5.9_aarch64.dmg](macos/latest/Cipher_0.5.9_aarch64.dmg) | 2.7MB | `55ae616b236c...` |
| **Linux (DEB)** | [cipher_0.5.9_amd64.deb](linux/latest/cipher_0.5.9_amd64.deb) | ~15MB | `placeholder` |
| **Linux (AppImage)** | [Cipher_0.5.9_x86_64.AppImage](linux/latest/Cipher_0.5.9_x86_64.AppImage) | ~18MB | `placeholder` |
...
wget https://github.com/aosmith/cipher/releases/download/v0.5.9/cipher_0.5.9_amd64.deb
sudo dpkg -i cipher_0.5.9_amd64.deb
...
wget https://github.com/aosmith/cipher/releases/download/v0.5.9/Cipher_0.5.9_x86_64.AppImage
chmod +x Cipher_0.5.9_x86_64.AppImage

# Run directly
./Cipher_0.5.9_x86_64.AppImage
```
