...
|----------|----------|------|---------|
| **Windows** | [Cipher_0.7.2_x64.msi](windows/latest/Cipher_0.7.2_x64.msi) | ~12MB | `placeholder` |
| **macOS (ARM64)** | [Cipher_0.7.2_aarch64.dmg](macos/latest/Cipher_0.7.2_aarch64.dmg) | 2.7MB | `55ae616b236c...` |
| **Linux (DEB)** | [cipher_0.7.2_amd64.deb](linux/latest/cipher_0.7.2_amd64.deb) | ~15MB | `placeholder` |
| **Linux (AppImage)** | [Cipher_0.7.2_x86_64.AppImage](linux/latest/Cipher_0.7.2_x86_64.AppImage) | ~18MB | `placeholder` |
...
wget https://github.com/aosmith/cipher/releases/download/v0.7.2/Cipher_0.7.2_x86_64.AppImage
chmod +x Cipher_0.7.2_x86_64.AppImage

# Run directly
./Cipher_0.7.2_x86_64.AppImage
```
